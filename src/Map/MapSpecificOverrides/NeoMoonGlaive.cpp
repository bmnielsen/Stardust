...
ForgeGatewayWall NeoMoonGlaive::getWall(BWAPI::TilePosition startTile)
{
    ...
    result.cannons.emplace_back(46, 20);
    result.cannons.emplace_back(46, 18);
    ...
    result.gapEnd1 = BWAPI::Position(BWAPI::TilePosition(38, 19)) + BWAPI::Position(16, 16);
    result.gapEnd2 = BWAPI::Position(BWAPI::TilePosition(42, 20)) + BWAPI::Position(16, 16);
    result.gapCenter = BWAPI::Position(BWAPI::TilePosition(40, 20)) + BWAPI::Position(16, 0);
    result.gapSize = 3;
