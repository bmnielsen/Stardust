...
void ProductionManager::onUnitDestroy(BWAPI::Unit unit)
{
	...
	// Replace static defenses in some cases if we have a forge and the location is still powered
	if (unit->getType() == BWAPI::UnitTypes::Protoss_Photon_Cannon &&
		...
		(BWAPI::Broodwar->getFrameCount() < 10000 || (BWAPI::Broodwar->enemy()->getRace() != BWAPI::Races::Protoss &&
...
void ProductionManager::startExtractorTrick(BWAPI::UnitType type)
{
	...
	// item--Locutus used to do that, but Arrak found the bug.
